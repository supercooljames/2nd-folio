...
class Member_register extends Member {
    ...
    function register_member()
    {
		...
		*/
        ...
        $query = $DB->query("SELECT m_field_id, m_field_name, m_field_label, m_field_required FROM exp_member_fields WHERE m_field_reg = 'y' ORDER BY m_field_order");
	...
	function activate_member()
	{
        ...
        $query = $DB->query("SELECT member_id, group_id, email FROM exp_members WHERE group_id = 4 AND authcode = '".$DB->escape_str($id)."'");        
