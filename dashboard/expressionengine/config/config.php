...
// Dynamic Paths
$srv_subdir 						= ""; //for subdirectory of a server root include a trailing slash: "subdir/path/here/"
$base_url                       	= "http://{$_SERVER['HTTP_HOST']}/" . $srv_subdir;
$base_path                      	= "{$_SERVER['DOCUMENT_ROOT']}/" . $srv_subdir;

$system_folder                  	= "dashboard";
...
$config['server_path'] 				= $base_path;
$config['system_folder'] 			= $system_folder;
$config['cp_url']               	= $base_url . $system_folder . $config['index_page'];
...
$config['tmpl_file_basepath'] 		= $base_path . $system_folder . "/expressionengine/templates/";
