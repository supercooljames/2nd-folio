...
<html>
	<head>
		<title>{exp:weblog:entries weblog="tasks" limit="1" dynamic="on" orderby="random"}{title} | Quotes | {/exp:weblog:entries}2nd Folio</title>
	...
	<body>
		...
		<div class="container">
			...
			<div class="span-24">
				{if segment_2 == ""}
					{exp:weblog:entries weblog="tasks" limit="1" dynamic="on" orderby="random"}				
				{if:else}
					{exp:weblog:entries weblog="tasks" limit="1" dynamic="on"}
				{/if}
